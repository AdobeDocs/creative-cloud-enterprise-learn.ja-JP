...
description: Adobe&reg; InDesign&reg;サーバーソフトウェアは、InDesignのデザイン、レイアウト、およびタイポグラフィ機能を活用する堅牢でスケーラブルなエンジンを提供し、プログラムを使用して魅力的な自動ドキュメントを作成することができます
...
® Serverは、InDesignのデザイン機能、レイアウト機能、タイポグラフィー機能を活用する堅牢でスケーラブルなエンジンであり、プログラムを使用して魅力的な自動文書を作成できます。
...
## データドリブンInDesign Serverコンテンツ(4:14) {#tutorial1}
