...
<tr>
  ...
  <td>
      <a href="searchstock.md">
         <img alt="Adobe[!DNL Stock]のライセンス履歴の検索" src="assets/StockSearch_1280.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="handdrawn.md">
         <img alt="Adobeの[!DNL Stock]枚の画像に手描きの美しさを加える" src="assets/handdrawn.jpg" />
      </a>
      <div>
  ...
  <td>
   <a href="flairtypography.md">
      <img alt="マスクとアニメーションを使用してタイポグラフィに魅力を加える" src="assets/flairtypography.jpg" />
   </a>
    <div>
...
<tr>
  <td>
      <a href="animatevector.md">
         <img alt="PhotoshopでAdobe [!DNL Stock]のベクターイラストをアニメーション化する" src="assets/animatevector.jpg" />
      </a>
      <div>
 ...
 <td>
      <a href="annualreport.md">
         <img alt="Adobe[!DNL Stock]とSpark Videoで作成したビデオで年間レポートを開始します" src="assets/annualreport.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="customanimations.md">
         <img alt="Adobeごとのカスタムアニメーションでクリエイティブに命を吹き込む [!DNL Stock]" src="assets/customanimations.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="changecolors.md">
         <img alt="ストーリーに合わせてAdobe [!DNL Stock]の画像の色を変更します" src="assets/changecolors.jpg" />
      </a>
      <div>
...
<tr>
 <td>
      <a href="collage.md">
         <img alt="Adobe [!DNL Stock]の画像を使用して、ポスターの3Dコラージュを作成します" src="assets/collage.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="boldlabel.md">
         <img alt="Adobe [!DNL Stock]のテンプレートとPhotoshopのスマートオブジェクトで太字のラベルを作成" src="assets/boldlabel.jpg" />
      </a>
      <div>
...
<tr>
   <td>
      <a href="surrealcomposite.md">
         <img alt="Adobeを使用してセミシュールな合成画像を作成する [!DNL Stock]" src="assets/surrealcomposite.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="interactivetourismphoto.md">
         <img alt="Adobe[!DNL Stock]とXDでインタラクティブな観光写真を作成" src="assets/interactivetourismphoto.jpg" />
      </a>
      <div>
...
<tr>
 <td>
      <a href="animationemail.md">
         <img alt="Adobe[!DNL Stock]とPhotoshopを使用して電子メールのアニメーションを作成する" src="assets/animationemail.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="brandgradients.md">
         <img alt="美しいグラデーションとAdobe [!DNL Stock]の素材で、統一感のあるブランドイメージを作成します" src="assets/brandgradients.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="webgraphics.md">
         <img alt="Adobe [!DNL Stock]の画像をCSSと組み合わせて、魅力的なwebグラフィックを作成します" src="assets/webgraphics.jpg" />
      </a>
      <div>
...
<tr>
   <td>
      <a href="realisticcomposite.md">
         <img alt="Adobe [!DNL Stock]枚の画像でリアルな写真合成を作成" src="assets/realisticcomposite.jpg" />
      </a>
      <div>
   ...
   <a href="loadingscreen.md">
      <img alt="Adobe [!DNL Stock]とXDを使用して読み込み画面のアニメーションをカスタマイズする" src="assets/loadingscreen.jpg" />
   </a>
    <div>
  ...
  <td>
   <a href="presentationtemplate.md">
      <img alt="Adobe [!DNL Stock]のプレゼンテーションテンプレートをカスタマイズして、プロフェッショナルでありながら人目を引くデザインにします" src="assets/presentationtemplate.jpg" />
   </a>
    <div>
   ...
   <a href="customizecolors.md">
      <img alt="Adobe [!DNL Stock]のベクターイラストの色をカスタマイズする" src="assets/customizecolors.jpg" />
   </a>
    <div>
...
<tr>
   <td>
      <a href="assets/AddMotiontoStillImageswithAdobeStockandPhotoshop.pdf">
         <img alt="Adobe [!DNL Stock]とPhotoshopを使用して静止画にモーションを追加する" src="assets/AddMotiontoStillImageswithAdobeStockandPhotoshop.jpg" />
      </a>
      <div>
   ...
   <a href="assets/CreateacompositewithPhotoshopontheiPadandAdobeStockimages.pdf" target="_blank">
      <img alt="iPad上のPhotoshopとAdobe [!DNL Stock]の画像で合成を行う" src="assets/CreateacompositewithPhotoshopontheiPadandAdobeStockimages.jpg" />
   </a>
    <div>
   ...
   <a href="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.pdf" target="_blank">
      <img alt="PhotoshopでAdobe [!DNL Stock]のベクターイラストをアニメーション化する" src="assets/CreateaUniqueEditorialGraphicwithAfterEffectsandAdobeStock.jpg" />
   </a>
    <div>
   ...
   <td>
      <a href="assets/CreateUniqueGraphicsbyCombiningAdobeStockImages.pdf" target="_blank">
         <img alt="Adobe [!DNL Stock]の画像を組み合わせてユニークなグラフィックを作成" src="assets/CreateUniqueGraphicsbyCombiningAdobeStockImages.jpg" />
      </a>
      <div>
  ...
  <td>
   ...
   <td>
      <a href="assets/PutyourDatainMotionwithAdobeStockandPremierePro.pdf" target="_blank">
         <img alt="Adobe [!DNL Stock]とPremiere Proを使用してデータを移動します" src="assets/PutyourDatainMotionwithAdobeStockandPremierePro.jpg" />
      </a>
      <div>
   ...
   <td>
      <a href="assets/RecolorAdobeStockVectorArtworkwithAdobeIllustratortoGetExactlytheLookYouWant.pdf" target="_blank">
         <img alt="Adobe IllustratorでAdobe [!DNL Stock]のベクターアートワークを再配色して、思い通りの外観に仕上げます" src="assets/RecolorAdobeStockVectorArtworkwithAdobeIllustratortoGetExactlytheLookYouWant.jpg" />
      </a>
      <div>
   ...
   <td>
      <a href="assets/ShowOffyourDesignWorkintheRealWorldwithAdobeStockandPhotoshop.pdf" target="_blank">
         <img alt="Adobe [!DNL Stock]とPhotoshopを使用して、デザイン作品を実際の世界で披露しましょう" src="assets/ShowOffyourDesignWorkintheRealWorldwithAdobeStockandPhotoshop.jpg" />
      </a>
      <div>
 ...
 <tr>
   <td>
      <a href="assets/UncoveramazingdetailsinAdobeStockimageswithLightroomformobile.pdf" target="_blank">
         <img alt="Lightroom for mobileを使用して、Adobe [!DNL Stock]の画像の美しいディテールを際立たせましょう" src="assets/UncoveramazingdetailsinAdobeStockimageswithLightroomformobile.jpg" />
      </a>
      <div>
  ...
  <td>
      <a href="assets/VisualizePosterDesignsintheRealWorldwithAdobeStockandPhotoshop.pdf" target="_blank">
         <img alt="Adobe [!DNL Stock]とPhotoshopを使用して、実際のポスターのデザインを視覚化します" src="assets/VisualizePosterDesignsintheRealWorldwithAdobeStockandPhotoshop.jpg" />
      </a>
      <div>
