...
## クイックリファレンスガイドのPDF（アルファベット順に記載されている製品）をクリックしてダウンロード
...
<tr>
 <td>
   <a href="CreateEditandShareaWebPagewithSpark.pdf">
    ...
    <div>
   <a href="CreateEditandShareaWebPagewithSpark.pdf"><strong>Spark で Web ページを作成、編集、共有 (PDF)</strong></a>
    </div>
...
<tr>
  ...
  <td>
   ...
   <a href="GetMoreAttentionwithMotionfromAdobeStock.pdf">
    ...
    <div>
   <a href="GetMoreAttentionwithMotionfromAdobeStock.pdf"><strong>Adobe [!DNL Stock] (PDF)</strong></a>
    </div>
...
<tr>
  <td>
   <a href="ShowOffYourDesignWorkintheRealWorld.pdf">
    ...
    <div>
   <a href="ShowOffYourDesignWorkintheRealWorld.pdf"><strong>デザイン作業を現実の世界でアピール (PDF)</strong></a>
    </div>
