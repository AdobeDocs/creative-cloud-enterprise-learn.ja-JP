---
title: スケッチして3Dに変換
description: スケッチを3Dキャラクターに変換する方法を説明します
...
スケッチを3Dキャラクターに変換する方法を説明します。 このグラフは、回転する3Dターンアラウンドを構築し、物理的なプロトタイプを作成する前に内部のデザインレビューを行うことができます。 [スケッチを開いて3Dのターンアラウンドテンプレートを作成](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:984a5ded-67e1-5a78-9283-52a0126bf8b2)。
