---
title: 設計システムジェネレータ
description: Webサイトのスクリーンショットに基づいてデザインシステムを生成する方法について説明します
...
webサイトのスクリーンショットに基づいてデザインシステムを生成する方法について説明します。 グラフを使用すると、一致するアイコン、パターン、レイアウトコンポーネントのセットを1回のバッチ処理で生成できます。 [デザインシステムジェネレーターを開きます](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:b40cd34c-66b2-586c-ab4a-5595490cded6)。
...
![デザインシステムジェネレーター](../../assets/design-system.png){align="center"}
