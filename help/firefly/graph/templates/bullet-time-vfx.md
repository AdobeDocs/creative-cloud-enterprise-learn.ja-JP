...
description: ヒーロー製品や被写体の画像にフィードして、その周りに一連の角度を回転させ、フリーズフレームスイープを自動的に組み合わせる方法を説明します
...
ヒーロー製品や被写体の画像にフィードして、その周りに一連の角度を回転させ、フリーズしたフレームスイープを自動的に組み合わせる方法を説明します。 [Bullet Time VFXテンプレートを開く](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:3efb4f51-345d-58eb-b7c8-7b289f0dd1c4)。
