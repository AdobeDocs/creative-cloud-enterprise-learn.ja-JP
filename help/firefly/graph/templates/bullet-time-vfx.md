...
ヒーロー製品または被写体画像に画像をフィードして、回転する
周囲を角度を付け、フリーズフレームスイープを自動的にステッチします。 [Bullet Time VFXテンプレートを開く](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:3efb4f51-345d-58eb-b7c8-7b289f0dd1c4)。
