---
title: エディトリアル写真
description: モデルリファレンスを入力し、新しい外観ごとに服飾の入力を入れ替える方法を学習します
...
モデルリファレンスを入力し、新しい外観ごとに服飾の入力を入れ替える方法を学習します。 ポーズおよびライティングノードはセット全体でロックされたままであるため、編集の雰囲気は一貫しています。 [エディトリアルフォトシュートテンプレートを開く](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:cfd7b810-2f86-5cdf-af80-dd2e31b8b84b)。
