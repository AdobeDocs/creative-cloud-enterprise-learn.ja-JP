...
* [**ブランディングの視覚化**](/help/firefly/graph/templates/branding-visualization.md) – このグラフテンプレートでは、製品のシーンを視覚化する方法について説明します。 ブランドガイドラインまたはロゴとカラーパレットを使用してフィードし、1回の操作で静的キーアートと短いモーションパスの両方を出力するので、両方の形式が視覚的に揃ったままになります。
