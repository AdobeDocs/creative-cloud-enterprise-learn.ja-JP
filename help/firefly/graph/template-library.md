...
| グラフテンプレート | 説明 | 活用例 |
|---|---|---|
| [**開始 – 画像を生成する**](/help/firefly/graph/templates/get-started-gen-image.md) | 1つのプロンプトノードを1つの生成ノードに1つの出力に変換した基本グラフ。 | <ul><li>ヒーロー画像</li><li>Placeholder test</li><li>サンプル画像</li></ul> |
...
| グラフテンプレート | 説明 | 活用例 |
|---|---|---|
| [**はじめに – 画像をセグメント化する**](/help/firefly/graph/templates/get-started-segment-image.md) | 任意のソース画像を読み込み、セグメンテーションノードを実行して、被写体を背景から分離します。 | <ul><li>カットアウトを消去</li><li>カタログの分離</li><li>バックドロップの入れ替え</li></ul> |
| [**レイヤーの合成とブレンド**](/help/firefly/graph/templates/composite-blend-layers.md) | 製品のカットアウトと背景シーンを別々のレイヤー入力として積み重ねます。 | <ul><li>ライフスタイル/ソーシャル合成</li><li>ホームページバナー</li><li>oブランドのコンポジット</li></ul> |
