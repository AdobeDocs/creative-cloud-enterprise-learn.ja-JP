...
コンピューターで生成された 3D シーン内の光のメカニズムは、レイトレーシングと呼ばれる処理を通じて、光子散乱の自然な原理と同じように作用します。 光線はシェイプに跳ね返ってマテリアルと相互作用し、最終画像でオブジェクトがどのように見えるかを効果的に定義します。 ライトは、3D シーンに存在するあらゆる要素の次元を公開します。
